...
function searchStats() {
	...
	echo "<h3>&nbsp;</h3><h3>Top 10 searches last 30 days <span class='btns'><a class='button' href='stats.php'>back</a></span></h3><table id='stats' class='sttable'>\n";
	...
	echo "<h3>&nbsp;</h3><h3>Most searched words (>50) <span class='btns'><a class='button' href='stats.php'>back</a></span></h3><table id='stats' class='sttable'>\n";
	echo "<thead><tr><th data-sort='string'>▽ word</th><th data-sort='int' data-sort-default='desc'>▽ searches</th></tr>
			</thead><tbody>\n";

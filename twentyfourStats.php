...
function twentyfourStats($q, $l) {
	...
	$txt = "{$dt} <span class='btns'><div class='button' data-go='30'>30 days</div> <div class='button' data-go='ref'>referrals</div> <div class='button' data-go='s'>topics</div> <div class='button' data-go='m'>montlhy</div></span>";

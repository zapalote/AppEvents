...
function userStats() {
	...
	printf("<h3>Users per hit range (last 30 days) <span class='btns'><div class='button' data-go=''>back</div></span></h3><table id='stats' class='sttable'>\n");
	$total = 0; $users = 0;
	...
	echo "<h3>&nbsp;</h3><h3>Power users (>50 hits) last 30 days <span class='btns'><div class='button' data-go=''>back</div></span></h3><table id='stats' class='sttable'>\n";
	$users = 0;
	...
	echo "<h3>&nbsp;</h3><h3>Power users (>50 hits) since Jan 2017 <span class='btns'><div class='button' data-go=''>back</div></span></h3><table id='stats' class='sttable'>\n";
	$users = 0;
	echo "<thead><tr><th data-sort='string'>▽ user</th><th data-sort='int' data-sort-default='desc'>▽ hits</th></tr>
			</thead><tbody>\n";
	while ($e = $res->fetch_row()) {
